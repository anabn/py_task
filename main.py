...
# 3. Напишите функцию, которая принимает на вход два параметра: a и b.
    ...
    a = 12
    b = "str"
    print(" out parameters are : " + str(a) + ", " + str(b))
...
# 4. Напишите функцию, которая принимает на вход три параметра
    ...
    startYear = 1900
    finishYear = 2020
    print(" our years' range : [ " + str(startYear) + ", " + str(finishYear) + " ]")
    print(" exclude list from range : " + str(c))
    print(Task4.listOfLeapYearsOnRange(startYear, finishYear, c))
#  array for task 5-9
    array = [1, "sd", 3, 1.2, 5.6, 0, -1]
# 5. Найти сумму элементов массива
    print("<--------- Task 5 --------->")
    print(" given array : " + str(array))
    print(" array sum : " + str(Task5.array_sum(array)))    
# 6. Найти максимальный элемент, значение и индекс.
    print("<--------- Task 6 --------->")
    print(" max in array and index : " + str(Task6.array_max(array)))
# 7. Найти минимальный элемент, значение и индекс.
    print("<--------- Task 7 --------->")
    print(" min in array and index : " + str(Task7.array_min(array)))
# 8. Посчитать количество элементов больше нуля.
    print("<--------- Task 8 --------->")
    print(" the amount of numbers greater than 0 : " + str(Task8.array_count(array)))
# 9. Прибавить к элементам массива их индекс.
    print("<--------- Task 9 --------->")
    print(" increase array by adding their index: " + str(Task9.array_increase_index(array)))
# 10. Циклический сдвиг элементов массива на k- позиций вправо.
    print("<--------- Task 10 --------->")
    k = 2
    print(" right step: " + str(k))
    print(" array to compare:\t\t" + str(array))
    print(" using python fuction:\t\t" + str(Task10.shiftUsingPyFunction(array, k)))
    print(" using created algorithm:\t" + str(Task10.shiftUsingPyFunction(array, k)))
# 11. Вывести элементы одного массива, которые не равны элементам второго массива.
    ...
    print(" initial first array : " + str(first_array))
    print(" initial second array : " + str(second_array))
...
# 12. Из двух отсортированных массивов сделать третий отсортированный, не сортируя его.
    ...
    sortedArrayA = [2, 4, 8]
    sortedArrayB = [5, 2, 1]
    print(" initial first array (sorted in fuction) : " + str(sortedArrayA))
    print(" initial second array ((sorted in fuction): " + str(sortedArrayB))
